...
for train_index, test_index in skf.split(data, labels):
    ...
    #SVM
    model = LinearSVC(verbose = 5, dual=False, random_state=123)
...
dump(model, 'D:/Escritorio/Corpoica/Canopy Attributes/SVM.joblib')

#######################
# CANOPY ATTRIBUTES
#######################
model = load('D:/Escritorio/Corpoica/Canopy Attributes/SVM.joblib')
output = open(root_out + 'Canopy Attributes_SVM.csv', 'w')
