...
for train_index, test_index in skf.split(data, labels):
    ...
    #XGB Classifier
    model = XGBClassifier(use_label_encoder=False, booster='gbtree', random_state = 123)
...
filename = 'D:/Escritorio/Corpoica/Canopy Attributes/XGBoost.dat'
pickle.dump(model, open(filename, 'wb'))   
#######################
# CANOPY ATTRIBUTES
#######################
#model = pickle.load(open(filename, "rb")) 
output = open(root_out + 'Canopy Attributes_XGBoost.csv', 'w')
